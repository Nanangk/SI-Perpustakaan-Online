...
<div class="navi">
  <div class="top-head">
    <ul>
      <li><button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">LOGIN ADMIN</button></li>
  ...
  <div class="mid-head">
    <ul>
      ...
      <li><a href="about.php"><b>TENTANG</b></a></li>
    </ul>
  </div>
...
<div id="id01" class="modal">
  <form class="modal-content animate" action="proses/login admin.php" method="POST">
