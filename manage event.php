...
<br>
<table align="center" width="70%" border="1"  cellpadding="10" cellspacing="0" align="center">
	...
	<?php 
		...
		$datanya = "SELECT * FROM event LIMIT $awal, $perhalaman";
		if(isset($_POST['cari'])){
  			$nama = $_POST['keyword'];
	...
	<tr align="center">
		...
		<td align="center"> <a href="proses/poster/<?php echo $data['poster']; ?>"><img src="proses/poster/<?php echo $data['poster']; ?>" width="120" heigth="160"></a></td>
		<td><input type="button" name="view" value="view" id="<?php echo $data["id"]; ?>" class="btn btn-info btn-xs view_data" /></td>
		<td><a href="editevent.php?id=<?php echo $data['id']; ?>"><img style="width:38px; height:38px;" src="Buttons/pencil2.png"></a></td>
		<td><a href="Tindakan/hapusevent.php?id=<?php echo $data['id']; ?>"><img style="width:38px; height:38px;" src="Buttons/delete.png"></a></td>
...
<a href="tambah event.php">
		<button style="width:20%; height:35px; display:block; margin-left:40%; margin-right:40%;">Tambah Event</button>
	</a>
