...
<div class="navi">
	<div class="top-head">
		<ul>
			...
			<a href="daftar.php"><li style="border-right: 1px solid white;">DAFTAR</li></a>
		</ul>
	</div>
...
<div class="buku-baru-section">
	...
	<?php 
			...
			$datanya = "SELECT * FROM buku ORDER BY id DESC LIMIT 3";
			$query = mysqli_query($conn, $datanya);
			while ($data = mysqli_fetch_assoc($query)){
...
<div id="id01" class="modal">
  <form class="modal-content animate" action="proses/login.php" method="POST">
    ...
    <div class="container">
      <label for="email"><b>No Perpustakaan</b></label>
      <input type="text" placeholder="Masukkan No Perpustakaan" name="email" required>
